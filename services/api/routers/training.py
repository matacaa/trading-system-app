...
@router.post("/train")
async def train(req: TrainRequest, user: dict = Depends(get_current_user)):
    """Encola un job de training.
    TODO fase 6: encolar en Service Bus en vez de subprocess.
    """
    import sys
    ...
    return {"experiment_name": exp_name, "user_id": user["id"], **result}
